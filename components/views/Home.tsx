    ...
    <div className="h-full overflow-y-auto bg-wade-bg-app px-6 pt-4 pb-24">
      ...
      <section className="bg-wade-bg-card rounded-3xl p-6 shadow-sm border border-wade-border mb-4 relative overflow-hidden group">
        ...
        <div className="relative z-10">
          <div className="flex items-center justify-between mb-2">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" className={isGeneratingQuote ? "animate-spin" : ""}>
      ...
      <section className="mb-4">
         <div className="flex justify-between items-end mb-4 px-1">
            ...
            >
              View All <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg>
            </button>
         </div>
      ...
      <section>
        <div className="flex justify-between items-end mb-4">
          ...
          >
            View All <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" className="ml-0.5"><polyline points="9 18 15 12 9 6"></polyline></svg>
          </button>
        </div>
