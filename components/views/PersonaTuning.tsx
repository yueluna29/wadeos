              ...
              <div className="bg-wade-bg-card rounded-[24px] shadow-sm border border-wade-border overflow-hidden">
                ...
                <div className="px-5 pb-6 relative">
                   <div className="relative -mt-10 mb-4 flex flex-row items-end gap-4">
                      ...
                      {/* 名字在头像右边 */}
                      <div className="pb-2">
                        <h3 className="font-display text-3xl text-wade-text-main tracking-tight">Wade Wilson</h3>
                      </div>
                   </div>
              ...
              <div className="bg-wade-bg-card rounded-[24px] shadow-sm border border-wade-border overflow-hidden">
                ...
                <div className="px-5 pb-6 relative">
                   <div className="relative -mt-10 mb-4 flex flex-row items-end gap-4">
                      ...
                      {/* 名字在头像右边 */}
                      <div className="pb-2">
                        <h3 className="font-display text-3xl text-wade-text-main tracking-tight">Luna</h3>
                      </div>
                   </div>
